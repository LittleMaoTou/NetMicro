...
using NetMicro.Core.Security.Principals;
...
namespace NetMicro.Core.Helper
{
    ...
    public static partial class Web
    {
        ...
        static Web()
        {
            try
            {
                HttpContextAccessor = ServiceLocator.Create<IHttpContextAccessor>();
                Environment = ServiceLocator.Create<IHostingEnvironment>();
            }
            catch
            {
            }
